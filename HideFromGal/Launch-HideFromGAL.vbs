' Launches HideFromGAL.ps1 with no PowerShell console window.
'
...
ps1Path   = fso.BuildPath(scriptDir, "HideFromGAL.ps1")

If Not fso.FileExists(ps1Path) Then
    MsgBox "Could not find HideFromGAL.ps1 next to this launcher." & vbCrLf & vbCrLf & _
           "Expected: " & ps1Path, vbCritical, "AD User GAL Manager"
    WScript.Quit 1
End If
